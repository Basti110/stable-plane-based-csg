...
static pm::face_handle addHalfFaceDependOnSplitEdges(pm::Mesh& mesh, pm::halfedge_handle& edgeOnFace, pm::vertex_handle firstVertex, pm::vertex_handle secondVertex) {
...
static std::vector<pm::face_handle> splitAccordingToIntersection(pm::face_handle triangle, std::vector<pm::face_handle>& triangles, PlaneMesh& planeMesh1, PlaneMesh& planeMesh2)
{
    pm::face_handle t2;
