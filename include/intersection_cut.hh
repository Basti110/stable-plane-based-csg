...
private:
    ...
    //Schnitt Plane Erstes Face (direction * plane) zeigt nach außen (signed distance = -1)
...
private:
    ...
    long long testTimeCount4 = 0;
    long long testTimeCount5 = 0;
    long long testTimeCount6 = 0;
    long long testTimeCount7 = 0;
